...
| API | Usage | Docs |
|-----|-------|------|
| [Spoonacular](https://spoonacular.com/food-api) | Recipe search, meal planner, and nutrition info. (Usage data of Spoonacular key of 50 point per day) | [Docs](https://spoonacular.com/food-api/docs) |
